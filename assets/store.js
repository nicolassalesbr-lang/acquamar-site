...
(function () {
  ...
  var CATALOG = [
    ...
    // ── MAIÔS ──
    { id: 'maio-lycra-cavado', n: 'Maiô Lycra Cavado Costas Nuas', col: 'Coleção Lycra', cat: 'Maiôs', ref: '030 005 010 0022', pr: 449, img: 'images/prod-m1.jpg?v=5', tags: 'maio lycra cavado costas nuas frente unica body', badge: ['pl', 'Ed. Limitada'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Marrom', '#6b4a2f'], ['Azul Marinho', '#1a2a4a'], ['Preto', '#1e1a16']], d: 'Maiô cavado com decote halter, recortes laterais e costas nuas. Lycra de alta compressão que modela a silhueta com elegância atemporal.' },
