...
(function () {
  ...
  var CATALOG = [
    // ── BIQUÍNIS ──
    { id: 'biq-millis-bandeau', n: 'Biquíni Millis Power Bandeau', col: 'Coleção Millis Power', cat: 'Biquínis', ref: '030 001 190 0084', pr: 329, img: 'images/prod-b1.jpg?v=4', tags: 'millis power bandeau estampado floral biquini', badge: ['pn', 'Novo'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Penca', '#c2603a'], ['Mimosa Turquesa', '#3aa898'], ['Angra', '#5a7a9a']], d: 'Top bandeau na exclusiva estampa Millis Power, com bojo removível e elástico forrado. Tecido de alta sustentação, secagem rápida e proteção UV50+.' },
    { id: 'biq-millis-cortininha', n: 'Biquíni Millis Power Cortininha', col: 'Coleção Millis Power', cat: 'Biquínis', ref: '030 001 190 0077', pr: 339, img: 'images/prod-b2.jpg?v=4', tags: 'millis power cortininha estampado floral biquini', sizes: ['P', 'M', 'G', 'GG'], colors: [['Angra', '#9a5a4a'], ['Maraú', '#2a3a52'], ['Taípe', '#4a6a88']], d: 'Cortininha de amarração ajustável com aviamento dourado nas alças. Estampa Millis Power assinada pela Acquamar, com forro duplo e ótima cobertura.' },
    { id: 'biq-cali-cortininha', n: 'Biquíni Cali Cortininha', col: 'Coleção Cali', cat: 'Biquínis', ref: '030 001 198 0005', pr: 299, img: 'images/prod-b3.jpg?v=4', tags: 'cali cortininha liso vibrante neon biquini', badge: ['pn', 'Novo'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Verde Limão', '#c4d22a'], ['Violeta', '#7a3aca'], ['Líchia', '#e0455a'], ['Preto', '#1e1a16']], d: 'Cortininha triângulo na linha Cali, em tecido texturizado de cores vibrantes. Amarração no pescoço e nas costas para um caimento sob medida.' },
    { id: 'biq-cali-bandeau', n: 'Biquíni Cali Bandeau', col: 'Coleção Cali', cat: 'Biquínis', ref: '030 002 198 0011', pr: 309, img: 'images/prod-b4.jpg?v=4', tags: 'cali bandeau liso vibrante biquini', sizes: ['P', 'M', 'G', 'GG'], colors: [['Verde Tiffany', '#2fb9a6'], ['Líchia', '#e0455a']], d: 'Bandeau tomara-que-caia com puxador frontal e calcinha de amarração lateral. Textura canelada e cores que são a cara do verão.' },
    { id: 'biq-cali-tqc', n: 'Biquíni Cali Tomara Que Caia', col: 'Coleção Cali', cat: 'Biquínis', ref: '030 002 198 0016', pr: 319, img: 'images/prod-b5.jpg?v=4', tags: 'cali tomara que caia cortininha biquini', sizes: ['P', 'M', 'G', 'GG'], colors: [['Líchia', '#e0455a'], ['Violeta', '#7a3aca'], ['Verde Tiffany', '#2fb9a6'], ['Branco', '#f0e8da'], ['Preto', '#1e1a16']], d: 'Modelagem tomara-que-caia franzida que valoriza o colo, com calcinha cortininha. Disponível em seis cores vibrantes da linha Cali.' },
    { id: 'biq-lycra-argola', n: 'Biquíni Lycra Argola', col: 'Coleção Lycra', cat: 'Biquínis', ref: '030 002 010 0011', pr: 289, img: 'images/prod-b6.jpg?v=4', tags: 'lycra argola liso preto biquini', sizes: ['P', 'M', 'G', 'GG'], colors: [['Preto', '#1e1a16'], ['Roxo', '#6a2a8a'], ['Azul Dark', '#1a2238'], ['Verde Militar', '#4a5a3a']], d: 'Top com detalhe de argola e calcinha de puxador frontal em lycra encorpada. O básico de luxo que veste como uma segunda pele.' },
    { id: 'biq-lycra-tira', n: 'Biquíni Lycra Tira Fina', col: 'Coleção Lycra', cat: 'Biquínis', ref: '030 002 010 0002', pr: 279, img: 'images/prod-b7.jpg?v=4', tags: 'lycra tira fina borboleta liso biquini', sizes: ['P', 'M', 'G', 'GG'], colors: [['Cru', '#e6dcc8'], ['Cinza', '#b0b0b0'], ['Pistache', '#c4d46a']], d: 'Triângulo de tiras finas com acabamento em viés contrastante e calcinha borboleta. Leveza e bronzeado sem marcas.' },
    // ── MAIÔS ──
    { id: 'maio-lycra-cavado', n: 'Maiô Lycra Cavado Costas Nuas', col: 'Coleção Lycra', cat: 'Maiôs', ref: '030 005 010 0022', pr: 449, img: 'images/prod-m1.jpg?v=4', tags: 'maio lycra cavado costas nuas frente unica body', badge: ['pl', 'Ed. Limitada'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Marrom', '#6b4a2f'], ['Azul Marinho', '#1a2a4a'], ['Preto', '#1e1a16']], d: 'Maiô cavado com decote halter, recortes laterais e costas nuas. Lycra de alta compressão que modela a silhueta com elegância atemporal.' },
    { id: 'maio-millis-decote', n: 'Maiô Millis Power Decote V', col: 'Coleção Millis Power', cat: 'Maiôs', ref: '030 005 190 0054', pr: 469, img: 'images/prod-m2.jpg?v=4', tags: 'maio millis power decote v frente unica estampado body', sizes: ['P', 'M', 'G', 'GG'], colors: [['Oasis', '#3a3a40'], ['Angra', '#5a7a9a'], ['Maraú', '#2a3a52']], d: 'Decote em V transpassado e alças cruzadas nas costas, na estampa exclusiva Millis Power. Sustentação total para curtir da praia ao jantar.' },
    { id: 'maio-carmel-cruzado', n: 'Maiô Carmel Frente Cruzada', col: 'Coleção Carmel', cat: 'Maiôs', ref: '030 005 215 0056', pr: 459, img: 'images/prod-m3.jpg?v=4', tags: 'maio carmel frente cruzada bojo body', badge: ['pn', 'Novo'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Verde Bandeira', '#1f6b4f'], ['Azul Jeans', '#4a6a9a']], d: 'Maiô gola alta com frente cruzada e bojo embutido, em tecido texturizado Carmel. Cobertura generosa e caimento impecável.' },
    // ── VESTIDOS & SAÍDAS ──
    { id: 'vestido-fluxy-midi', n: 'Vestido Fluxy Midi Transpassado c/ Cinto', col: 'Coleção Fluxy', cat: 'Saídas', ref: '030 010 009 0157', pr: 389, img: 'images/prod-v1.jpg?v=4', tags: 'vestido fluxy midi transpassado cinto saida', badge: ['pl', 'Exclusivo'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Oasis', '#b5604a']], d: 'Vestido midi em viscose Fluxy de toque fluido, decote transpassado com argola e cinto que marca a cintura. Da praia ao pôr do sol sem trocar de look.' },
    { id: 'vestido-fluxy-fu', n: 'Vestido Fluxy Frente Única', col: 'Coleção Fluxy', cat: 'Saídas', ref: '030 010 009 0158', pr: 369, img: 'images/prod-v2.jpg?v=4', tags: 'vestido fluxy frente unica longo saida', sizes: ['P', 'M', 'G', 'GG'], colors: [['Azul Marinho', '#1a2a4a'], ['Preto', '#1e1a16'], ['Verde Militar', '#4a5a3a']], d: 'Vestido longo frente única com decote em V e costas nuas. Tecido Fluxy leve e fresco que acompanha o movimento. Elegância descomplicada.' },
    { id: 'saia-pareo', n: 'Saia Pareo Microfibra Longa', col: 'Coleção Praia', cat: 'Saídas', ref: '030 006 003 0054', pr: 259, img: 'images/prod-v3.jpg?v=4', tags: 'saia pareo microfibra longa estampada saida', sizes: ['Único'], colors: [['Penca', '#c2603a']], d: 'Pareô longo com fenda e amarração lateral em microfibra de secagem rápida. A saída de praia mais versátil — vire saia, vestido ou lenço.' },
    { id: 'calca-fluxy-pantalona', n: 'Calça Fluxy Pantalona c/ Bolsos', col: 'Coleção Fluxy', cat: 'Saídas', ref: '030 013 009 0168', pr: 329, img: 'images/prod-v4.jpg?v=4', tags: 'calca fluxy pantalona bolsos saida', badge: ['pn', 'Novo'], sizes: ['P', 'M', 'G', 'GG'], colors: [['Taípe', '#4a6a88'], ['Marrom', '#6b4a2f']], d: 'Pantalona de cintura alta com cordão e bolsos, em viscose Fluxy. O coringa do guarda-roupa de verão — leve sobre o biquíni ou com regata.' },
    // ── ACESSÓRIOS ──
    { id: 'ace-chapeu', n: 'Chapéu de Praia Palha', col: 'Curadoria Acquamar', cat: 'Acessórios', ref: '030 030 017 0023', pr: 189, img: 'images/prod-a1.jpg?v=4', tags: 'chapeu praia palha acessorio', sizes: ['Único'], colors: [['Cru / Natural', '#e0d4bc']], d: 'Chapéu de aba larga em palha trançada com fita preta. Proteção e estilo para os dias de sol — dobrável e fácil de levar na mala.' },
    { id: 'ace-bolsa-boho', n: 'Bolsa Tiracolo Boho', col: 'Curadoria Acquamar', cat: 'Acessórios', ref: '030 025 017 0026', pr: 229, img: 'images/prod-a2.jpg?v=4', tags: 'bolsa tiracolo boho palha redonda acessorio', badge: ['pn', 'Novo'], sizes: ['Único'], colors: [['Camelo', '#c89a5a'], ['Bege', '#d4c2a0']], d: 'Bolsa redonda de palha trançada à mão com alça regulável e fecho de borla. Cabe canga, protetor e o essencial para um dia perfeito de praia.' }
  ];
